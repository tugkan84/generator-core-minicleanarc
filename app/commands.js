...
const CreateScripts = (projectName,projectFolder,sdk) => {
    ...
    const scripts = [
        ...
        { script:'cd '+ this.apiName +' && dotnet add package Microsoft.Extensions.DependencyInjection -v 2.2.0', folder:projectFolder },
        ...
        { script:'cd '+ this.coreName +' && dotnet add package Microsoft.Extensions.Logging -v 2.2.0', folder:projectFolder },
        { message:'Packages preparing for infrastructure...'},
        { script:'cd '+ this.infraName +' && dotnet add package Microsoft.EntityFrameworkCore.SqlServer -v 2.2.0', folder:projectFolder },
        { script:'cd '+ this.infraName +' && dotnet add package Microsoft.EntityFrameworkCore.Design', folder:projectFolder },
        { script:'cd '+ this.infraName +' && dotnet add package Microsoft.EntityFrameworkCore.Tools -v 2.2.0', folder:projectFolder },
